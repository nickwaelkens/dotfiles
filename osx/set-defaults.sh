...
sudo scutil --set ComputerName "Nickbook Pro"
sudo scutil --set HostName "NickbookPro"
sudo scutil --set LocalHostName "NickbookPro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "NickbookPro"
